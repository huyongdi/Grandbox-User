    ...
    <div class="done-list">
      ...
      <div class="all-content">
        <div class="title-list">
          <div @click="changeContent" data-type="1" class="title-single active">质控统计</div>
          <div @click="changeContent" data-type="2" class="title-single">变异详情</div>
          <div @click="changeContent" data-type="3" class="title-single">线粒体</div>
        </div>
        <div class="detail-content">
          <div class="content-0" :class="{hide:!in1}">
            <div class="bold">质控详情</div>
            <ul class="bold">
              <li>基因分析报告 :<router-link target="_blank" class="common-a" :to="{path:'/report',query:{code:sn}}">点击查看</router-link></li>
            </ul>
            <table class="table my-table">
              ...
              <tbody>
              <tr v-for="(list,index) in lists1" :class="{'trIn':index%2}">
                <td>{{list.name}}</td>
                <td>{{list.value}}</td>
              </tr>
              </tbody>
          ...
          <div class="content-1" :class="{hide:!in2}">
                  ...
                  <!--<div class="content">-->
                    ...
                    <!--<div class="single">-->
                      ...
                      <!--<div class="right">-->
                        ...
                        <!--&lt;!&ndash;<span class="option" data-value="0.02">2%</span>&ndash;&gt;-->
                        <!--&lt;!&ndash;<span class="option" data-value="0.05">5%</span>&ndash;&gt;-->
                        <!--<span class="option in default">不筛选</span>-->
                      <!--</div>-->
                    <!--</div>-->
                    <!--<div class="single">-->
            ...
            <!--<table class="table my-table" id="table-1">-->
              ...
              <!--</thead>-->
              <!--<tbody>-->
              <!--&lt;!&ndash; @click="showLocus(data.variant.chrom+':'+data.variant.start+':'+data.variant.end+':'+data.variant.ref+':'+data.variant.alt,0)">&ndash;&gt;-->
              ...
              <!--<tr v-for="(data,index) in lists1" :class="{'tr-bc':index%2}">-->
                <!--<td class="">-->
                  ...
                  <!--<a class="po common-a" v-if="data.variant"-->
                    ...
                    <!--&lt;!&ndash;<span&ndash;&gt;-->
                    <!--&lt;!&ndash;v-if="data.variant.start == data.variant.end">{{data.variant.chrom}}:{{data.variant.start}}({{data.variant.ref}}/{{data.variant.alt}})</span>&ndash;&gt;-->
                    <!--&lt;!&ndash;<span&ndash;&gt;-->
                    <!--&lt;!&ndash;v-else="">{{data.variant.chrom}}:{{data.variant.start}}-{{data.variant.end}}({{data.variant.ref}}/{{data.variant.alt}})</span>&ndash;&gt;-->
                  <!--</a>-->
                <!--</td>-->
                <!--<td class="warp">-->
                    <!--<span v-if="data.anno">-->
                ...
                <!--</td>-->
                <!--&lt;!&ndash;<diseaseTd :geneResp="data.geneResp" @sendPhenotypeMapSingle="getPhenotypeMapSingle"></diseaseTd>&ndash;&gt;-->
                ...
                <!--</td>-->
                <!--&lt;!&ndash;<td><span v-if="data.anno.freqs">{{data.anno.freqs.grandfreq | getPercent}}</span></td>&ndash;&gt;-->
              ...
              <!--<tr v-if="lists1.length == 0 && doneHttp">-->
                <!--<td colspan="11" class="center noResult-td">-->
                  <!--&lt;!&ndash;当前暂无筛选结果，请尝试在页面上方修改信息或筛选条件&ndash;&gt;-->
                  <!--<img src="../../static/img/no-result-1.png" alt="">-->
                <!--</td>-->
                <!--&lt;!&ndash;<td colspan="11" class="center" v-else="">暂无数据</td>&ndash;&gt;-->
              <!--</tr>-->
          ...
          <div class="content-4" :class="{hide:!in3}">
            <!--<div class="top-content">-->
              <!--<span class="con"><span class="title red">已选条件：</span>-->
