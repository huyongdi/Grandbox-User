  ...
  <div class="row" id="cap-list">
    ...
    <div class="sg-list col-sm-11">
      ...
      <table id="sg-table" class="bc-fff my-table">
        ...
        <tbody>
        <tr v-for="(val,index) in lists" @click="addIn" class="not-base" :class="{'tr-bc':index%2}">
          <td class="check-td">
            ...
            <div class="modal-body" id="">
              ...
              <form id="addDataFormCap">
                ...
                <div class="row">
                  ...
                  <div class="col-md-9">
                    <input type="text" class="form-control" id="edit-name" name="code">
                  </div>
                </div>
                <div class="row ">
                  <div class="col-md-3">出产厂家</div>
                  <div class="col-md-9">
                    <input type="text" class="form-control" id="edit-maker" name="maker">
                  </div>
                </div>
                <div class="row noneBottom">
                  <div class="col-md-3">捕获芯片</div>

                  <div class="upload-content col-md-9" id="upload">
                    <input type="text" class="show-name" id="" @click.stop="">
                    <span class="text">选择</span>
                    <input type='file' name="bed" class="hide-input" id="hide-add" @click.stop="">
                  </div>
                </div>
              </form>
  ...
  export default {
    ...
    methods: {
      ...
      editFun: function (data) {
        ...
        $('#edit-name').val(this.editModalData.code)
        $('#edit-maker').val(this.editModalData.maker)
      ...
      saveEdit: function () {
        ...
        let myData = ''
        if ($('#hide-add').val()) {
          myData = new FormData(document.getElementById('addDataFormCap'))
        } else {
          myData = {
            code: $('#edit-name').val(),
