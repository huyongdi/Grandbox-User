          ...
          <div class="row">
            ...
            <div class="content">
              <div class="single">
                ...
                <div class="inline">
                  <span>受检者出生日：</span>
                  <el-date-picker v-model="birth" type="date" placeholder="选择日期" :picker-options="pickerOptions0">
                  </el-date-picker>
                </div>
                <div class="inline">
                  <span>受检者名族：</span>
                  <input type="text" v-model="nation" class="light-font">
                </div>
                <div class="inline">
                  <span>受检医院：</span>
                  <input type="text" v-model="hospital" class="light-font">
                </div>
              </div>
            </div>
        ...
        this.myAxios({
          ...
          data:{
            ...
            patient:{
              ...
              birthday:_vue.birth,
              nation:_vue.nation,
              hospital:_vue.hospital,
            },
            sample:{
              code:$.trim($("#patient-code").val()),
            },
            capture: $.trim($("#capture-id").val()),
//            capture:{
