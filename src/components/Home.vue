        ...
        <div class="shadow" id="home-content">
          ...
          <div class="content">
            <div class="row topRow">
              <div class="col-md-6">
                <img src="../../static/img/home-1.jpg" alt="" @click="toPage('dataA/foo/sgList')">
                <div class="right" @click="toPage('dataA/foo/sgList')">
                  <div class="right-title">分析流程</div>
                  <div class="remark">基因测序与芯片数据全自动化分析</div>
                </div>
              </div>
              <div class="col-md-6">
                <img src="../../static/img/home-2.jpg" alt=""  @click="toPage('dataA/foo/cnvList')">
                <div class="right" @click="toPage('dataA/foo/cnvList')">
            ...
            <div class="row topRow">
              <div class="col-md-6">
                <img src="../../static/img/home-3.png" alt="" @click="toPage('dataA/foo/trioList')">
                <div class="right" @click="toPage('dataA/foo/trioList')">
