      ...
      <ul class="under-left">
        ...
        <li>
          ...
          <div @click.stop="" class="children" style="display: none">
            <router-link to="/taskM/foo/reportSe" data-code='reportSe' class="block">
              在线报告查询
            </router-link>
            <!--<router-link to='/taskM/foo/reportSt' data-code="reportSt" class="block">-->
              <!--报告统计-->
            <!--</router-link>-->
          </div>
        </li>
          ...
          if (name === currentPath) {
            $(".children").find('a').each(function () {
              if ($(this).data('code') === code) {
                ...
                if($(this).closest('li').find('.children').css("display") == 'none'){
